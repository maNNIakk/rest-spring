package br.com.restspring.integrationtests.controller.withjson;
...
public class PersonControllerJsonTest extends AbstractIntegrationTest {
	...
	public void authorization()
		...
		var accessToken = given().basePath("/auth/signin")
				...
				.contentType(TestConfigs.CONTENT_TYPE_JSON).body(user).when()
				.post().then().statusCode(200).extract().body()
...
//		.as(new TypeRef<List<PersonVO>>() {});
		...
		assertTrue(content.contains("\"_links\":{\"self\":{\"href\":\"http://localhost/api/person/v1/423"));
		assertTrue(content.contains("\"_links\":{\"self\":{\"href\":\"http://localhost/api/person/v1/211"));
		assertTrue(content.contains("\"_links\":{\"self\":{\"href\":\"http://localhost/api/person/v1/75"));
