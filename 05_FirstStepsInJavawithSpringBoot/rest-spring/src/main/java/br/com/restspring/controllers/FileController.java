...
import br.com.restspring.data.vo.v1.UploadFileResponseVO;
import br.com.restspring.services.FileStorageService;
...
public class FileController {
	...
	public UploadFileResponseVO uploadFile(
		...
		String fileDownloadUri = ServletUriComponentsBuilder
				.fromCurrentContextPath().path("/api/file/v1/downloadFile/")
