...
import br.com.restspring.controllers.PersonController;
...
public class PersonServices {
	...
	public PagedModel<EntityModel<PersonVO>> findPersonByName(String firstname,
			Pageable pageable) {
	...
	public PersonVO findById(Long id) {
		...
		vo.add(linkTo(methodOn(PersonController.class).findById(id))
				.withSelfRel());
		return vo;
	}
	...
	public PersonVO create(PersonVO person) {
		...
		var vo = DozerMapper.parseObject(repository.save(entity),
				PersonVO.class);
		vo.add(linkTo(methodOn(PersonController.class).findById(vo.getKey()))
				.withSelfRel());
		return vo;
